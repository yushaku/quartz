...
```mermaid
flowchart TD
    A["✅ Làm được<br/>(Small win)"] --> B["💪 Cảm giác<br/>có năng lực"]
    B --> C["🎯 Thử thách<br/>khó hơn"]
    C --> A
...
```mermaid
flowchart TD
    X["❌ Không thấy<br/>progress"] --> Y["📉 Efficacy<br/>giảm"]
    Y --> Z["🚫 Né tránh<br/>task"]
    Z --> X

    style X fill:#fee2e2,stroke:#dc2626,color:#7f1d1d
    style Y fill:#fee2e2,stroke:#dc2626,color:#7f1d1d
...
flowchart LR
    SDT["🔵 SDT"]
    SE["🟢 Self-Efficacy"]
    PP["🟡 Progress Principle"]

    I1["Thiếu cảm giác có hiệu quả => mất động lực"]
    I2["Reward bên ngoài phá vỡ động lực nội tại"]
    I3["Mục tiêu nhỏ, gần tạo vòng tích cực"]
    I4["Feedback thông tin tốt hơn khen thưởng"]

    SDT --> I1 & I2 & I3 & I4
    SE  --> I1 & I2 & I3 & I4
    PP  --> I1 & I2 & I3 & I4

    style SDT fill:#dbeafe,stroke:#2563eb,color:#1e3a8a
    style SE  fill:#dcfce7,stroke:#16a34a,color:#14532d
    style PP  fill:#fef9c3,stroke:#ca8a04,color:#713f12
    style I1  fill:#f3e8ff,stroke:#9333ea,color:#581c87
    style I2  fill:#f3e8ff,stroke:#9333ea,color:#581c87
    style I3  fill:#f3e8ff,stroke:#9333ea,color:#581c87
    style I4  fill:#f3e8ff,stroke:#9333ea,color:#581c87
```
