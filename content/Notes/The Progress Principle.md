...
```mermaid
flowchart LR
    A["🏆 Progress nhỏ"] --> B["😊 Inner Work Life tốt<br/>cảm xúc tích cực · tự tin hơn"]
    B --> C["🧠 Hiệu suất tăng<br/>sáng tạo · tập trung · hợp tác"]
    C --> A

    style A fill:#d4edda,stroke:#28a745,color:#155724
    style B fill:#cce5ff,stroke:#0056b3,color:#003d80
    style C fill:#fff3cd,stroke:#856404,color:#533f03
```
...
```mermaid
flowchart LR
    P["❌ Không thấy<br/>progress"] --> S["😔 Cảm giác<br/>trì trệ"]
    S --> M["😶 Mất<br/>động lực"]
    M --> V["🚫 Né tránh<br/>task"]
    V --> P

    style P fill:#f8d7da,stroke:#842029,color:#58151c
    style S fill:#f8d7da,stroke:#842029,color:#58151c
    style M fill:#f8d7da,stroke:#842029,color:#58151c
    style V fill:#f8d7da,stroke:#842029,color:#58151c
```
